...
async function main() {
    ...
    var t0 = "0x3C844FB5AD27A078d945dDDA8076A4084A76E513";
    var t1 = "0xa158A39d00C79019A01A6E86c56E96C461334Eb0";
    let nft = await StakeNFT721.deploy(52, 2, 52, beginTime, endTime, rewardToken, t0, t1, fee, NFT, tcikMax);
    await nft.deployed();
    console.log(`deployed pool(sSOON, sETH) StakeNFT721 to ${nft.address}`);
